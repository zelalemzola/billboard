...
export default function Home() {
  ...
  return (
   ...
   <div className="h-screen w-full flex flex-col-reverse md:flex-row items-center justify-evenly md:justify-between px-2 md:px-6 py-10 ">
     <h1 className=" w-[90%] md:w-1/2 text-2xl text-center mx-auto flex items-center flex-wrap">Having the Previlege to access a platform that specifically advertizes businesses help&apos;s your business Meet the right <FlipWords words={words1}/><br/> and Grow Your Business  <FlipWords words={words2}/>  </h1>
